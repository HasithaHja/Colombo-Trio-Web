          ...
          <div className="layout-content-container flex flex-col max-w-[960px] flex-1">
                ...
                <div className="flex min-w-72 flex-col gap-3">
                    ...
                    <p className="text-sm font-normal leading-normal"
                       style={{ color: theme === 'dark' ? '#9CA3AF' : '#6B7280' }}>
                        We offer a wide range of software development services to help your business grow.
                    </p>
                </div>
            </div>
            ...
            <div className="flex px-4 py-3 justify-center">
                <button 
                  ...
                  onMouseOver={(e) => e.target.style.backgroundColor = theme === 'dark' ? '#2563EB' : '#1D4ED8'}
                  onMouseOut={(e) => e.target.style.backgroundColor = theme === 'dark' ? '#3B82F6' : '#2563EB'}
                >
